...
For comprehensive examples of subagents including code reviewers, test runners, debuggers, and security auditors, see the [main Subagents guide](../build-with-claude-code/sub-agents.md#example-subagents). The guide includes detailed configurations and best practices for creating effective subagents.
...
* [Main Subagents Guide](../build-with-claude-code/sub-agents.md) - Comprehensive subagent documentation
...
* [Slash Commands](../reference/slash-commands.md) - Custom command creation
