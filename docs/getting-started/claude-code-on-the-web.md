...
1. **Use Claude Code hooks**: Configure [sessionStart hooks](../reference/hooks.md#sessionstart) to automate environment setup, dependency installation, and network configuration
