...
* **ripgrep**: Usually included with Claude Code. If search functionality fails, see [search troubleshooting](../build-with-claude-code/troubleshooting.md#search-and-discovery-issues).
...
Set the `DISABLE_AUTOUPDATER` environment variable in your shell or [settings.json file](../configuration/settings.md):
