...
* **Sandboxed bash tool**: [Sandbox](../deployment/sandboxing.md) bash commands with filesystem and network isolation, reducing permission prompts while maintaining security. Enable with `/sandbox` to define boundaries where Claude Code can work autonomously
...
When using [Claude Code on the web](../getting-started/claude-code-on-the-web.md), additional security controls are in place:
...
For more details on cloud execution, see [Claude Code on the web](../getting-started/claude-code-on-the-web.md).
...
* [Sandboxing](../deployment/sandboxing.md) - Filesystem and network isolation for bash commands
