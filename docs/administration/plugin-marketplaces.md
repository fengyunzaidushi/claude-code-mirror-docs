...
Plugin entries can override default component locations and provide additional metadata. Note that `${CLAUDE_PLUGIN_ROOT}` is an environment variable that resolves to the plugin's installation directory (for details see [Environment variables](../reference/plugins-reference.md#environment-variables)):
...
For complete plugin testing workflows, see [Test your plugins locally](../build-with-claude-code/plugins.md#test-your-plugins-locally). For technical troubleshooting, see [Plugins reference](../reference/plugins-reference.md).
...
* [Plugins](../build-with-claude-code/plugins.md) - Installing and using plugins
* [Plugins reference](../reference/plugins-reference.md) - Complete technical specifications and schemas
* [Plugin development](../build-with-claude-code/plugins.md#develop-more-complex-plugins) - Creating your own plugins
* [Settings](../configuration/settings.md#plugin-configuration) - Plugin configuration options
