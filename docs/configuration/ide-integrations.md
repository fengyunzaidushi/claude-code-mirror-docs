...
<Tip>
  If you're using WSL or WSL2 and the IDE is not detected, see our [WSL2 troubleshooting guide](../build-with-claude-code/troubleshooting.md#jetbrains-ide-not-detected-on-wsl2) for networking configuration and firewall settings.
</Tip>
