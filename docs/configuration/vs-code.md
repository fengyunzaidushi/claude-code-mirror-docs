...
* [Claude Code on Amazon Bedrock](../deployment/amazon-bedrock.md)
* [Claude Code on Google Vertex AI](../deployment/google-vertex-ai.md)

### Not Yet Implemented

The following features are not yet available in the VS Code extension:

* **Full MCP server configuration**: You need to [configure MCP servers through the CLI](../build-with-claude-code/mcp.md) first, then the extension will use them
* **Subagents configuration**: Configure [subagents through the CLI](../build-with-claude-code/sub-agents.md) to use them in VS Code
...
For additional help, see our [troubleshooting guide](../build-with-claude-code/troubleshooting.md).
