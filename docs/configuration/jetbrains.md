...
<Warning>
  WSL users may need additional configuration for IDE detection to work properly. See our [WSL troubleshooting guide](../build-with-claude-code/troubleshooting.md#jetbrains-ide-not-detected-on-wsl2) for detailed setup instructions.
</Warning>
...
* For WSL users, see the [WSL troubleshooting guide](../build-with-claude-code/troubleshooting.md#jetbrains-ide-not-detected-on-wsl2)
