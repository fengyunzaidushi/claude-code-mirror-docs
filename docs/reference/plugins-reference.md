...
<Tip>
  For hands-on tutorials and practical usage, see [Plugins](../build-with-claude-code/plugins.md). For plugin management across teams and communities, see [Plugin marketplaces](../administration/plugin-marketplaces.md).
</Tip>
...
* [Use Skills in Claude Code](../build-with-claude-code/skills.md)
...
- [Plugins](../build-with-claude-code/plugins.md) - Tutorials and practical usage
- [Plugin marketplaces](../administration/plugin-marketplaces.md) - Creating and managing marketplaces
- [Slash commands](slash-commands.md) - Command development details
- [Subagents](../build-with-claude-code/sub-agents.md) - Agent configuration and capabilities
- [Agent Skills](../build-with-claude-code/skills.md) - Extend Claude's capabilities
- [Hooks](hooks.md) - Event handling and automation
- [MCP](../build-with-claude-code/mcp.md) - External tool integration
