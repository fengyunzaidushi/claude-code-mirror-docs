...
| `--agents`                       | Define custom [subagents](../build-with-claude-code/sub-agents.md) dynamically via JSON (see below for format)                                                   | `claude --agents '{"reviewer":{"description":"Reviews code","prompt":"You are a code reviewer"}}'` |
...
For more details on creating and using subagents, see the [subagents documentation](../build-with-claude-code/sub-agents.md).
