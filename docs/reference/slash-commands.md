...
| `/cost`                   | Show token usage statistics (see [cost tracking guide](../administration/costs.md#using-the-cost-command) for subscription-specific details) |
...
[Plugins](../build-with-claude-code/plugins.md) can provide custom slash commands that integrate seamlessly with Claude Code. Plugin commands work exactly like user-defined commands but are distributed through [plugin marketplaces](../administration/plugin-marketplaces.md).
...
When configuring [permissions for MCP tools](../administration/iam.md#tool-specific-permission-rules), note that **wildcards are not supported**:
...
Learn more about [Agent Skills](../build-with-claude-code/skills.md).

## See also

* [Plugins](../build-with-claude-code/plugins.md) - Extend Claude Code with custom commands through plugins
* [Identity and Access Management](../administration/iam.md) - Complete guide to permissions, including MCP tool permissions
