...
<Note>
  **Next steps**: Ready to add more features? Jump to [Develop more complex plugins](#develop-more-complex-plugins) to add agents, hooks, and MCP servers. For complete technical specifications of all plugin components, see [Plugins reference](../reference/plugins-reference.md).
</Note>
...
For detailed marketplace management including Git repositories, local development, and team distribution, see [Plugin marketplaces](../administration/plugin-marketplaces.md).
...
For complete instructions including configuration examples, marketplace setup, and rollout best practices, see [Configure team marketplaces](../administration/plugin-marketplaces.md#how-to-configure-team-marketplaces).
...
For plugins with many components, organize your directory structure by functionality. For complete directory layouts and organization patterns, see [Plugin directory structure](../reference/plugins-reference.md#plugin-directory-structure).
...
<Note>
  **For multiple plugins**: Organize plugins in subdirectories like `./plugins/plugin-name` and update your marketplace.json accordingly. See [Plugin sources](../administration/plugin-marketplaces.md#plugin-sources) for organization patterns.
</Note>
...
3. **Use validation and debugging tools**: See [Debugging and development tools](../reference/plugins-reference.md#debugging-and-development-tools) for CLI commands and troubleshooting techniques
...
<Note>
  For complete technical specifications, debugging techniques, and distribution strategies, see [Plugins reference](../reference/plugins-reference.md).
</Note>
...
* **Create your first marketplace**: [Plugin marketplaces guide](../administration/plugin-marketplaces.md)
