...
Then set `USE_BUILTIN_RIPGREP=0` in your [environment](../configuration/settings.md#environment-variables).
...
For additional JetBrains configuration tips, see our [IDE integration guide](../configuration/ide-integrations.md#jetbrains-plugin-settings).
