...
<Warning>
  ...
  `--system-prompt`, `--append-system-prompt`, CLAUDE.md, or [plugins](plugins.md) instead.
...
See the [CLI reference](../reference/cli-reference.md#system-prompt-flags) for detailed guidance on when to use each flag.
