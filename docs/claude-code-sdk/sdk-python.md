...
The Python SDK accepts all arguments supported by the [command line](../reference/cli-reference.md) through the `ClaudeCodeOptions` class.
...
* [GitHub Actions integration](../build-with-claude-code/github-actions.md) - Automate your GitHub workflow with Claude
